  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container max-w-7xl mx-auto flex h-14 items-center justify-between px-3 sm:px-6">
        ...
        {/* Botón Modo Oscuro visible SIEMPRE (Celular y PC) */}
        <Button
          variant="ghost"
          size="icon"
          onClick={toggleDarkMode}
          title={isDark ? "Modo Claro" : "Modo Oscuro"}
          className="size-9 rounded-full shrink-0 flex items-center justify-center border border-border/50 bg-muted/30"
        >
          {isDark ? (
