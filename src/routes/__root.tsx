  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container max-w-7xl mx-auto flex h-14 items-center justify-between px-3 sm:px-6">
        ...
        {/* Menú Horizontal para Pantallas Medianas/Grandes (PC / Tablet) */}
        ...
        {/* Único Botón de Modo Oscuro en la cabecera superior */}
        <Button
          variant="ghost"
          size="icon"
...
function BottomNav() {
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t bg-background/95 backdrop-blur px-0.5 py-1.5 flex items-center justify-between shadow-lg">
      <Link
        to="/"
        className="flex-1 flex flex-col items-center justify-center text-muted-foreground hover:text-foreground transition-colors"
        activeProps={{ className: "text-primary font-bold" }}
      >
        <LayoutDashboard className="size-4" />
        <span className="text-[9px] mt-0.5 truncate max-w-[42px]">Panel</span>
      </Link>
      ...
      >
        ...
        <span className="text-[9px] mt-0.5 truncate max-w-[42px]">Local</span>
      </Link>
      ...
      >
        ...
        <span className="text-[9px] mt-0.5 truncate max-w-[42px]">Sheet</span>
      </Link>
      ...
      >
        ...
        <span className="text-[9px] mt-0.5 truncate max-w-[42px]">Equipos</span>
      </Link>
      ...
      >
        ...
        <span className="text-[9px] mt-0.5 truncate max-w-[42px]">Plantel</span>
      </Link>
      ...
      >
        ...
        <span className="text-[9px] mt-0.5 truncate max-w-[42px]">Material</span>
      </Link>
      ...
      >
        ...
        <span className="text-[9px] mt-0.5 truncate max-w-[42px]">Motor</span>
      </Link>
    </nav>
  );
}
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="relative flex min-h-screen flex-col bg-background text-foreground">
        <Navbar />
        <main className="flex-1 pb-20 md:pb-6 p-4 max-w-7xl mx-auto w-full">
          <Outlet />
        </main>
        <BottomNav />
      </div>
