...
function ConvocadosLocalPage() {
  ...
  const armarLocal = async () => {
    ...
    setArmando(true);
    try {
      if (typeof (armadorService as unknown as Record<string, Function>)?.armarConvocatoria === "function") {
        await (armadorService as unknown as Record<string, Function>).armarConvocatoria(convocatoriaActual.id);
      } else if (typeof (armadorService as unknown as Record<string, Function>)?.armarEquipos === "function") {
        await (armadorService as unknown as Record<string, Function>).armarEquipos(convocatoriaActual.id);
      }
      toast.success("Convocados locales organizados con éxito.");
